...
Note: `--force-with-lease` is safer than `--force` because it will fail if the remote branch has commits you haven't fetched yet, preventing accidental overwrites of other contributors' work.
